...
Final polish was rushed, causing minor UI glitches visible in the demo.
...
Front-loaded performance optimization with buffer (Sprint 3 action): implemented from day 2; the buffer handled both planned work and an unexpected hardware issue without delaying delivery. Customer praised the improved response time.
## Action points
